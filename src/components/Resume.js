        ...
        <Box component="header" className={classes.mainContainer}>
            ...
            <Box component="div" className={classes.timeLine}>
                ...
                <Box component="div" className={classes.timeLineItem}>
                    <Typography variant='h5' align='center' className={classes.subHeading}>job title</Typography>
                    <Typography variant='body1' align='center' style={{color: "tomato"}}>company name</Typography>
                    <Typography variant='subtitle1' align='center' style={{color: "tan"}}>description</Typography>
                </Box>
